      ...
      >
        ...
        <form className='mt-4'>
          ...
          >
            ...
            />
            <button className='flex w-[7rem] text-[12px] items-center ml-4 bg-gradient-to-r from-[#2600FC] to-[#FF00EA]  hover:from-[#FF00EA] hover:to-[#2600FC]  text-white px-6  py-2 rounded-full'>
              Subscribe
            </button>
          </label>
        </form>
